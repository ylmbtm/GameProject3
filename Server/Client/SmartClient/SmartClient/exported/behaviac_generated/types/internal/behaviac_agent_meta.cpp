...
public:
	...
	virtual bool load()
	{
		AgentMeta::SetTotalSignature(492532317u);
		...
		// CClientObject
		meta = BEHAVIAC_NEW AgentMeta(715367875u);
		AgentMeta::GetAgentMetas()[3373882369u] = meta;
		meta->RegisterMethod(1045109914u, BEHAVIAC_NEW CAgentStaticMethodVoid_1<char*>(FunctionPointer_CClientObject_LogMessage));
		meta->RegisterMethod(1505908390u, BEHAVIAC_NEW CAgentMethodVoid_1<behaviac::string>(FunctionPointer_CClientObject_SayHello));
		meta->RegisterMethod(2521019022u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorAdd());
		meta->RegisterMethod(2306090221u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorClear());
		meta->RegisterMethod(3483755530u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorContains());
		meta->RegisterMethod(505785840u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorLength());
		...
		AgentMeta::Register<CClientObject>("CClientObject");
	...
	virtual bool unLoad()
	{
		...
		AgentMeta::UnRegister<CClientObject>("CClientObject");
