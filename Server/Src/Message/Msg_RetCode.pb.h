...
enum MessageRetCode {
  ...
  MRC_INVALID_CARRERID = 13,
  MRC_NOT_ENOUGH_ACTOIN = 14,
  MRC_NOT_ENOUGH_MONEY = 15,
  MRC_NOT_ENOUGH_ITEM = 16,
  MRC_NOT_ENOUGH_TIMES = 17,
  MRC_SKILL_CD_ERROR = 18,
  MRC_INVALID_SKILL_ID = 19,
  MRC_INVALID_TARGET_ID = 20,
...
const MessageRetCode MessageRetCode_MAX = MRC_INVALID_TARGET_ID;
