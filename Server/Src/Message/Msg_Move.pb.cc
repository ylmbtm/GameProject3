...
void NewItem::SerializeWithCachedSizes(
  ...
  // int32 Speed = 21;
  if (this->speed() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(21, this->speed(), output);
  }
...
::google::protobuf::uint8* NewItem::InternalSerializeWithCachedSizesToArray(
  ...
  // int32 Speed = 21;
  if (this->speed() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(21, this->speed(), target);
  }
