...
inline bool DBPartnerItem::isusing() const {
  // @@protoc_insertion_point(field_get:DBPartnerItem.IsUsing)
  return isusing_;
}
inline void DBPartnerItem::set_isusing(bool value) {
  
  isusing_ = value;
  // @@protoc_insertion_point(field_set:DBPartnerItem.IsUsing)
}
