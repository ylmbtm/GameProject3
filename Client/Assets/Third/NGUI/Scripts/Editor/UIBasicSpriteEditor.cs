...
public class UIBasicSpriteEditor : UIWidgetInspector
{
	...
	protected override void DrawCustomProperties ()
	{
        ...
        if (type == UISprite.Type.Simple || type == UISprite.Type.Mirror || type == UIBasicSprite.Type.MirrorVertically || type == UIBasicSprite.Type.MirrorHorizonVertically || type == UIBasicSprite.Type.MirrorHorizonSliced)
		{
        ...
        else if (type == UISprite.Type.Filled || type == UIBasicSprite.Type.MirrorFilled || type == UISprite.Type.SlicedFilled)
		{
			NGUIEditorTools.DrawProperty("Flip", serializedObject, "mFlip");
        ...
        //else if (type == UISprite.Type.SlicedFilled)
        //{
        //    NGUIEditorTools.DrawProperty("Flip", serializedObject, "mFlip");
        //    NGUIEditorTools.DrawProperty("Fill Dir", serializedObject, "mFillDirection", GUILayout.MinWidth(20f));
        //    GUILayout.BeginHorizontal();
