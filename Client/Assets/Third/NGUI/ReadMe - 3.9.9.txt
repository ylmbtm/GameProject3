...
3.7.1
- NEW: Added generic delegates to UICamera you can subscribe to (onClick, onHover, etc) to replace the genericmdHandler.
...
1.84:
- FIX: Changed the way the font data is stored, resulting in potentially better ESceneType.TYPE_LOAD performance on mobile devices.
