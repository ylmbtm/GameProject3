...
{  
    ...
    public CharacterRagdoll                    Ragdoll        { get; set; }
    ...
    public GTCallback                          ReleaseFunc    { get; private set; }
    ...
    public bool                                IsAutoFight    { get; private set; }
    ...
    public Character(int id, int guid, EActorType type, EBattleCamp camp, bool isMain)
    {
        ...
        this.ReleaseFunc  = new GTCallback();
    }
    ...
    void InitBoard()
    {
        ...
        this.Board.SetHeight(Height * 1.5f);
    }
    ...
    void InitRagdoll()
    {
        ...
        {
            this.Ragdoll = new CharacterRagdoll(CacheTransform);
        }
    }
    ...
    public void DoDead(CommandDead cmd)
    {
        ...
        ReleaseFunc.AddListener(Skill.Release);
    ...
    public bool EnableRagdoll(bool enabled)
    {
        if (Ragdoll != null)
        {
            this.IsRagdoll = enabled;
            return this.Ragdoll.EnableRagdoll(enabled);
        }
        return false;
    }
    ...
    public void ChangeAutoFight(bool isAutoFight)
    {
        if (this.IsAutoFight == isAutoFight)
        {
            return;
        }
    ...
    public void ChangeAutoPaused(bool isAutoPaused)
    {
        if (this.IsAutoPaused == isAutoPaused)
        {
            return;
        }
    ...
    public List<Character> GetAffectCharacters(EAffect affect)
    {
        switch (affect)
        {
            ...
            case EAffect.Enem:
                return GetEnemys();
            case EAffect.Boss:
                return CharacterManager.Boss == null ? null : new List<Character>() { CharacterManager.Boss };
            case EAffect.Each:
    ...
    void SyncBaseAttr(XCharacter data)
    {
        ...
        CurrAttr.MaxHP = BaseAttr.MaxHP;
        CurrAttr.MaxMP = BaseAttr.MaxMP;
        CurrAttr.MaxSP = BaseAttr.MaxSP;
    }
