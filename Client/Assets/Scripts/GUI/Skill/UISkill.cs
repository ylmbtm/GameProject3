...
public class UISkill : GTWindow
{
    ...
    protected override void OnAwake()
    {
        ...
        mMenus[0] = transform.Find("Left/Menus/Menu_Skill").GetComponent<UIToggle>();
        mMenus[1] = transform.Find("Left/Menus/Menu_Talent").GetComponent<UIToggle>();
        mMenus[2] = transform.Find("Left/Menus/Menu_SkillSet").GetComponent<UIToggle>();
        ...
        mContent1 = transform.Find("Content/Content1");
        mContent2 = transform.Find("Content/Content2");
        mContent3 = transform.Find("Content/Content3");
