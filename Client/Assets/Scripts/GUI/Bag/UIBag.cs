...
public class UIBag : GTWindow
{
    ...
    {
        GTEventCenter.DelHandler(GTEventID.TYPE_SORT_BAG, OnRecvSortBag);
        ...
        GTEventCenter.DelHandler(GTEventID.TYPE_STRENGTHEN_EQUIP, OnRecvStrengthEquip);
        ...
        GTEventCenter.DelHandler(GTEventID.TYPE_STRENGTHEN_GEM, OnRecvStrengthGem);
    ...
    private void OnArrangeClick(GameObject go)
    {
        ...
        BagService.Instance.TrySortBag(mShow);
        mRemainTimer = 20;
